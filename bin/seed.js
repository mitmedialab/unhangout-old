...
exports.run = function(dbId, redis, callback) {
		redis.select(dbId, function(err) {
			...
			redis.flushdb(function(err) {
				...
				events.push(new models.Event({title:"Scratch Pedagodgy Unhangout", organizer: "MIT Media Lab & ConnectedLearning.tv",
				...
				events.push(new models.Event({title:"Open Source Learning Unhangout", organizer: "MIT Media Lab & ConnectedLearning.tv",
				...
				sessions.push(new models.Session());
				sessions.push(new models.Session());
				sessions.push(new models.Session());
				sessions.push(new models.Session());
				sessions.push(new models.Session());
