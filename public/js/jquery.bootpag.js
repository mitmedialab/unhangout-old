...
(function (f) {
    f.fn.bootpag = function (n) {
        function j(e, b) {
            ...
            c = 1 > b - 1 ? 1 : a.leaps && b - 1 >= a.maxVisible ? Math.floor(
                (b - 1) / d) * d : b - 1;
            g.first().toggleClass("disabled", 1 === b).attr("data-lp", c).find(
                "a").attr("href", h(c));
            m = 1 == a.maxVisible ? 0 : 1;
            c = b + 1 > a.total ? a.total : a.leaps && b + 1 < a.total - a.maxVisible ?
                l + a.maxVisible + m : b + 1;
            ...
            if (!d.not(".next,.prev").length) {
                ...
                g.not(".next,.prev").each(function (b) {
                    c = b + 1 + l + j;
                    f(this).attr("data-lp", c).toggle(c <= a.total).find(
                        "a").html(c).attr("href", h(c))
                });
                d = g.filter("[data-lp=" + b + "]")
            }
        ...
        return this.each(function () {
            var e, b, c = f(this),
                d = ['<div class="pagination" bootpag"><ul>'];
           
            for (b = 1; b <= Math.min(a.total, a.maxVisible); b++) d
                .push('<li data-lp="' + b + '"><a href="' + h(b) +
                    '">' + b + "</a></li>");
           
            d.push("</ul></div>");
            c.find("div.bootpag").remove();
            c.append(d.join(""));
            e = c.find("div.bootpag");
            c.find("li").click(function () {
                var a = f(this);
                a.hasClass("disabled") || (a = parseInt(a.attr(
                    "data-lp"), 10), j(e, a), k.trigger(
                    "page", a))
            });
            j(e, a.page)
        })
