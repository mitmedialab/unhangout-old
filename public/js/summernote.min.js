! function (a) {
    "function" == typeof define && define.amd ? define(["jquery", "codemirror"],
        a) : a(window.jQuery, window.CodeMirror)
}(function (a, b) {
    "function" != typeof Array.prototype.reduce && (Array.prototype.reduce =
        function (a, b) {
            var c, d, e = this.length >>> 0,
                f = !1;
            for (1 < arguments.length && (d = b, f = !0), c = 0; e > c; ++c)
                this.hasOwnProperty(c) && (f ? d = a(d, this[c], c, this) :
                    (d = this[c], f = !0));
            if (!f) throw new TypeError(
                "Reduce of empty array with no initial value");
            return d
        });
    var c = {
            bMac: navigator.appVersion.indexOf("Mac") > -1,
            bMSIE: navigator.userAgent.indexOf("MSIE") > -1 || navigator.userAgent
                .indexOf("Trident") > -1,
        ...
        e = function () {
            var a = function (a) {
                ...
                i = function (a) {
                    for (var b = [], c = -1, d = a.length; ++c < d;) b[c] =
                        a[c];
                    return b
                },
                j = function (c, d) {
                    ...
                    return f.reduce(function (a, c) {
                        var e = b(a);
                        return d(b(e), c) ? e[e.length] = c : a[a.length] = [
                            c
                        ], a
                    }, [
                        [a(c)]
                ...
                k = function (a) {
                    for (var b = [], c = 0, d = a.length; d > c; c++) a[c] &&
                        b.push(a[c]);
                    return b
                };
            return {
        ...
        f = function () {
            var b = function (b) {
                ...
                p = function (a, b) {
                    ...
                    return function f(g) {
                        if (g) {
                            if (g === a && (d = !0), d && !e && c.push(
                                g), g === b) return void(e = !0);
                            for (var h = 0, i = g.childNodes.length; i >
                                h; h++) f(g.childNodes[h])
                        }
                    }(o(a, b)), c
                },
                q = function (a, b) {
                ...
                z = function (a, b) {
                    for (var c = a, d = 0, e = b.length; e > d; d++) c = c.childNodes[
                        b[d]];
                    return c
                },
                A = function (a, b) {
                ...
                B = function (a, b, c) {
                    var e = n(b, d.eq(a));
                    return 1 === e.length ? A(b, c) : e.reduce(function (a,
                        d) {
                        var e = d.cloneNode(!1);
                        return t(e, d), a === b && (a = A(a, c)), u(
                            e, r(a)), e
                    })
                },
                C = function (a, b) {
                    if (a && a.parentNode) {
                        ...
                        if (!b) {
                            ...
                            for (d = 0, e = f.length; e > d; d++) c.insertBefore(
                                f[d], a)
                        }
                        c.removeChild(a)
                    }
        ...
        g = {
            ...
            options: {
                ...
                fontNames: ["Serif", "Sans", "Arial", "Arial Black",
                    "Courier", "Courier New", "Comic Sans MS", "Helvetica",
                    "Impact", "Lucida Grande", "Lucida Sans", "Tahoma",
                    "Times", "Times New Roman", "Verdana"
                ],
                colors: [
                    ["#000000", "#424242", "#636363", "#9C9C94", "#CEC6CE",
                        "#EFEFEF", "#F7F7F7", "#FFFFFF"
                    ],
                    ["#FF0000", "#FF9C00", "#FFFF00", "#00FF00", "#00FFFF",
                        "#0000FF", "#9C00FF", "#FF00FF"
                    ],
                    ["#F7C6CE", "#FFE7CE", "#FFEFC6", "#D6EFD6", "#CEDEE7",
                        "#CEE7F7", "#D6D6E7", "#E7D6DE"
                    ],
                    ["#E79C9C", "#FFC69C", "#FFE79C", "#B5D6A5", "#A5C6CE",
                        "#9CC6EF", "#B5A5D6", "#D6A5BD"
                    ],
                    ["#E76363", "#F7AD6B", "#FFD663", "#94BD7B", "#73A5AD",
                        "#6BADDE", "#8C7BC6", "#C67BA5"
                    ],
                    ["#CE0000", "#E79439", "#EFC631", "#6BA54A", "#4A7B8C",
                        "#3984C6", "#634AA5", "#A54A7B"
                    ],
                    ["#9C0000", "#B56308", "#BD9400", "#397B21", "#104A5A",
                        "#085294", "#311873", "#731842"
                    ],
                    ["#630000", "#7B3900", "#846300", "#295218", "#083139",
                        "#003163", "#21104A", "#4A1031"
                    ]
                ],
        ...
        j = function () {
            ...
            this.stylePara = function (b, c) {
                ...
                var e = a(f.isText(c.sc) ? c.sc.parentNode : c.sc),
                    g = ["font-family", "font-size", "text-align",
                        "list-style-type", "line-height"
                    ],
                    h = b(e, g) || {};
                if (h["font-size"] = parseInt(h["font-size"], 10), h[
                        "font-bold"] = document.queryCommandState("bold") ?
                    "bold" : "normal", h["font-italic"] = document.queryCommandState(
                        "italic") ? "italic" : "normal", h["font-underline"] =
                    document.queryCommandState("underline") ? "underline" :
                    "normal", h["font-strikethrough"] = document.queryCommandState(
                        "strikeThrough") ? "strikethrough" : "normal", c.isOnList()
                ) {
                ...
                if (k && k.style["line-height"]) h["line-height"] = k.style
                    .lineHeight;
                else {
                    var l = parseInt(h["line-height"], 10) / parseInt(h[
                        "font-size"], 10);
                    h["line-height"] = l.toFixed(1)
                }
                return h.image = f.isImg(d) && d, h.anchor = c.isOnAnchor() &&
                    f.ancestor(c.sc, f.isAnchor), h.aAncestor = f.listAncestor(
                        c.sc, f.isEditable), h
            }
        },
        k = function () {
            var b = !!document.createRange,
                c = function (a, b) {
                    ...
                    for (c = 0; c < i.length; c++)
                        if (!f.isText(i[c])) {
                            if (h.moveToElementText(i[c]), h.compareEndPoints(
                                "StartToStart", a) >= 0) break;
                            d = i[c]
                        }
                    if (0 !== c && f.isText(i[c - 1])) {
                        var j = document.body.createTextRange(),
                            k = null;
                        j.moveToElementText(d || g), j.collapse(!d), k = d ?
                            d.nextSibling : g.firstChild;
                        var l = a.duplicate();
                        l.setEndPoint("StartToStart", j);
                        for (var m = l.text.replace(/[\r\n]/g, "").length; m >
                            k.nodeValue.length && k.nextSibling;) m -= k.nodeValue
                            .length, k = k.nextSibling; {
                            k.nodeValue
                        }
                        b && k.nextSibling && f.isText(k.nextSibling) && m ===
                            k.nodeValue.length && (m -= k.nodeValue.length,
                                k = k.nextSibling), g = k, c = m
                    }
                    return {
                        cont: g,
                        offset: c
                ...
                g = function (a) {
                    var b = function (a, c) {
                            ...
                            if (f.isText(a)) {
                                ...
                                g = j || a.parentNode, c += e.sum(e.tail(i),
                                    f.length), h = !j
                            } else {
                        ...
                        g = b(a.cont, a.offset);
                    return c.moveToElementText(g.cont), c.collapse(g.collapseToStart),
                        c.moveStart("character", g.offset), c
                },
                h = function (c, h, i, j) {
                    ...
                    this.select = function () {
                        ...
                        if (b) {
                            ...
                            c.rangeCount > 0 && c.removeAllRanges(), c.addRange(
                                a)
                        } else a.select()
                    ...
                    this.isOnEditable = l(f.isEditable), this.isOnList = l(
                        f.isList), this.isOnAnchor = l(f.isAnchor), this.isOnCell =
                        l(f.isCell), this.isCollapsed = function () {
                            return c === i && h === j
                ...
                create: function (a, d, e, f) {
                    if (0 === arguments.length)
                        if (b) {
                            ...
                            a = i.startContainer, d = i.startOffset, e = i.endContainer,
                                f = i.endOffset
                        } else {
        ...
        l = function () {
            this.tab = function (a, b) {
                ...
                for (var d, e = [], g = 0; b > g; g++) e.push("<td>" + f.blank +
                    "</td>");
                d = e.join("");
                for (var h, i = [], j = 0; c > j; j++) i.push("<tr>" + d +
                    "</tr>");
                h = i.join("");
                var k = '<table class="table table-bordered">' + h +
                    "</table>";
                return a(k)[0]
            }
        },
        m = function () {
            ...
            }, g = ["bold", "italic", "underline", "strikethrough",
                "justifyLeft", "justifyCenter", "justifyRight",
                "justifyFull", "insertOrderedList",
                "insertUnorderedList", "indent", "outdent",
                "formatBlock", "removeFormat", "backColor",
                "foreColor", "insertHorizontalRule", "fontName"
            ], i = 0, m = g.length; m > i; i++) this[g[i]] = function (a) {
                return function (b, c) {
            ...
            this.tab = function (a, b) {
                ...
                if (g && 11 === g[2].length) {
                    var q = g[2];
                    d = a("<iframe>").attr("src",
                        "//www.youtube.com/embed/" + q).attr("width", "640")
                        .attr("height", "360")
                } else i && i[0].length > 0 ? d = a("<iframe>").attr("src",
                        i[0] + "/embed/").attr("width", "612").attr(
                        "height", "710").attr("scrolling", "no").attr(
                        "allowtransparency", "true") : l && l[0].length > 0 ?
                    d = a("<iframe>").attr("src", l[0] + "/embed/simple").attr(
                        "width", "600").attr("height", "600").attr("class",
                        "vine-embed") : n && n[3].length > 0 ? d = a(
                        "<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>"
                    ).attr("src", "//player.vimeo.com/video/" + n[3]).attr(
                        "width", "640").attr("height", "360") : p && p[2].length >
                    0 && (d = a("<iframe>").attr("src",
                        "//www.dailymotion.com/embed/video/" + p[2]).attr(
                        "width", "640").attr("height", "360"));
                d && (d.attr("frameborder", 0), k.create().insertNode(d[0]))
            }, this.formatBlock = function (a, b) {
                e(a), b = c.bMSIE ? "<" + b + ">" : b, document.execCommand(
                    "FormatBlock", !1, b)
            ...
            this.fontSize = function (a, b) {
                e(a), document.execCommand("fontSize", !1, 3), c.bFF ? a.find(
                    "font[size=3]").removeAttr("size").css("font-size", b +
                    "px") : a.find("span").filter(function () {
                ...
                if (b.isOnAnchor()) {
                    ...
                    b = k.createFromNode(c), b.select(), document.execCommand(
                        "unlink")
                }
                ...
                e(b);
                var i = d;
                if (-1 !== d.indexOf("@") && -1 === d.indexOf(":") ? i =
                    "mailto:" + d : -1 === d.indexOf("://") && (i =
                        "http://" + d), (c.bMSIE || c.bFF) && h.isCollapsed()
                ) {
                    h.insertNode(a('<A id="linkAnchor">' + d + "</A>")[0]);
                    var j = a("#linkAnchor").attr("href", i).removeAttr(
                        "id");
                    h = k.createFromNode(j[0]), h.select()
                } else document.execCommand("createlink", !1, i), h = k.create();
                a.each(h.nodes(f.isAnchor), function (b, c) {
                    g ? a(c).attr("target", "_blank") : a(c).removeAttr(
                        "target")
                })
                ...
                if (b.isOnAnchor()) {
                    ...
                    b = k.createFromNode(e), c = "_blank" === a(e).attr(
                        "target"), d = e.href
                }
                return {
                    text: b.toString(),
                ...
                var c = JSON.parse(b),
                    d = c.foreColor,
                    f = c.backColor;
                e(a), d && document.execCommand("foreColor", !1, d), f &&
                    document.execCommand("backColor", !1, f)
        ...
        n = function () {
            var a = [],
                ...
                d = function (a, b) {
                    a.html(b.contents).scrollTop(b.scrollTop), k.createFromBookmark(
                        a[0], b.bookmark).select()
                };
        ...
        o = function () {
            this.update = function (b, c) {
                ...
                if (g.length > 0) {
                    var h = c["font-family"];
                    h && (h = e.head(h.split(",")), h = h.replace(/\'/g, ""),
                        g.find(".note-current-fontname").text(h), d(g, h))
                }
                var i = b.find(".note-fontsize");
                i.find(".note-current-fontsize").text(c["font-size"]), d(i,
                    parseFloat(c["font-size"]));
                var j = b.find(".note-height");
                d(j, parseFloat(c["line-height"])), f(
                    'button[data-event="bold"]', function () {
                    ...
                    return "left" === c["text-align"] || "start" === c[
                        "text-align"]
                ...
                a.find("button").not('button[data-event="codeview"]').removeClass(
                    "disabled")
            }, this.deactivate = function (a) {
                a.find("button").not('button[data-event="codeview"]').addClass(
                    "disabled")
            }
        },
        p = function () {
            ...
            this.update = function (a, c) {
                ...
                if (c.anchor) {
                    var e = d.find("a");
                    e.attr("href", c.anchor.href).html(c.anchor.href), b(d,
                        c.anchor)
                } else d.hide();
                ...
                return a.Deferred(function (a) {
                    ...
                    e.one("shown.bs.modal", function () {
                        f.replaceWith(f.clone().on("change",
                            function () {
                                e.modal("hide"), a.resolve(
                                    this.files)
                            })), h.click(function (b) {
                            b.preventDefault(), e.modal(
                                "hide"), a.resolve(g.val())
                        }), g.keyup(function () {
                            b(h, g.val())
                        }).val("").focus()
                    }).one("hidden.bs.modal", function () {
                        c.focus(), f.off("change"), g.off(
                            "keyup"), h.off("click")
                    }).modal("show")
                })
                ...
                return a.Deferred(function (a) {
                    ...
                    f.one("shown.bs.modal", function () {
                        g.val(e.text).keyup(function () {
                            b(h, g.val())
                        }).trigger("keyup").trigger("focus"), h
                            .click(function (b) {
                                b.preventDefault(), f.modal(
                                    "hide"), a.resolve(g.val())
                            })
                    }).one("hidden.bs.modal", function () {
                        c.focus(), g.off("keyup"), h.off(
                            "click")
                    }).modal("show")
                })
                ...
                return a.Deferred(function (a) {
                    ...
                    f.one("shown.bs.modal", function () {
                        g.val(e.text), h.keyup(function () {
                            b(i, h.val()), e.text || g.val(
                                h.val())
                        }).val(e.url).trigger("focus"), j.prop(
                            "checked", e.newWindow), i.one(
                            "click", function (b) {
                                b.preventDefault(), f.modal(
                                    "hide"), a.resolve(h.val(),
                                    j.is(":checked"))
                            })
                    }).one("hidden.bs.modal", function () {
                        c.focus(), h.off("keyup")
        ...
        s = function () {
            var d = new m,
                ...
                v = function (a) {
                    ...
                    c && (g.update(b.toolbar(), c), j.update(b.popover(), c),
                        k.update(b.handle(), c))
                },
                w = function (a) {
                    var b = s(a.currentTarget || a.target);
                ...
                x = function (a) {
                    ...
                    if (b.clipboardData && b.clipboardData.items && b.clipboardData
                        .items.length) {
                        var c = s(a.currentTarget || a.target),
                            d = e.head(b.clipboardData.items),
                            f = "file" === d.kind && -1 !== d.type.indexOf(
                                "image/");
                ...
                y = function (b) {
                    if (f.isControlSizing(b.target)) {
                        ...
                        var c = s(b.target),
                            ...
                            h = c.editable(),
                            i = c.editor(),
                            l = e.find(".note-control-selection").data(
                                "target"),
                            m = a(l),
                            n = m.offset(),
                        ...
                        i.on("mousemove", function (a) {
                            ...
                            i.off("mousemove")
                        }), m.data("ratio") || m.data("ratio", m.height() /
                            m.width()), d.recordUndo(h)
                    }
                },
                z = function (b) {
                ...
                A = function (e) {
                    ...
                    if (h.length > 0) {
                        var i, j, k, m = h.attr("data-event"),
                            ...
                            w = o.codable(),
                            x = p.data("options");
                        if (-1 !== a.inArray(m, ["resize", "floatMe",
                            "removeMedia"
                        ])) {
                            var y = o.handle(),
                        ...
                        if (d[m] && (u.trigger("focus"), d[m](u, n, k)), -1 !==
                            a.inArray(m, ["backColor", "foreColor"])) g.updateRecentColor(
                            h[0], m, n);
                        else if ("showLinkDialog" === m) {
                            u.focus();
                            var A = d.getLinkInfo();
                            d.saveRange(u), l.showLinkDialog(u, r, A).then(
                                function (a, b) {
                                    d.restoreRange(u), d.createLink(u, a, b)
                                })
                        } else if ("showImageDialog" === m) u.focus(), l.showImageDialog(
                            u, r).then(function (a) {
                            "string" == typeof a ? (d.restoreRange(
                                u), d.insertImage(u, a)) : t(u, a)
                        });
                        else if ("showVideoDialog" === m) {
                            u.focus();
                            var B = d.getVideoInfo();
                            d.saveRange(u), l.showVideoDialog(u, r, B).then(
                                function (a) {
                                    d.restoreRange(u), d.insertVideo(u, a)
                                })
                        } else if ("showHelpDialog" === m) l.showHelpDialog(
                            u, r);
                        else if ("fullscreen" === m) {
                            var C = a("html, body"),
                                D = function (a) {
                                    p.css("width", a.w), u.css("height", a.h),
                                        w.css("height", a.h), w.data(
                                            "cmEditor") && w.data(
                                            "cmEditor").setSize(null, a.h)
                                };
                            p.toggleClass("fullscreen");
                            var E = p.hasClass("fullscreen");
                            E ? (u.data("orgHeight", u.css("height")), a(
                                window).on("resize", function () {
                                D({
                                    w: a(window).width(),
                                    h: a(window).height() - q.outerHeight()
                                })
                            }).trigger("resize"), C.css("overflow",
                                "hidden")) : (a(window).off("resize"), D({
                                w: x.width || "",
                                h: u.data("orgHeight")
                            }), C.css("overflow", "auto")), g.updateFullscreen(
                                q, E)
                        } else if ("codeview" === m) {
                            p.toggleClass("codeview");
                            var F = p.hasClass("codeview");
                            F ? (w.val(u.html()), w.height(u.height()), g.deactivate(
                                q), w.focus(), c.bCodeMirror && (j = b.fromTextArea(
                                    w[0], x.codemirror), x.codemirror.tern &&
                                (i = new b.TernServer(x.codemirror.tern),
                                    j.ternServer = i, j.on(
                                ...
                                }), w.data("cmEditor", j))) : (c.bCodeMirror &&
                                (j = w.data("cmEditor"), w.val(j.getValue()),
                                    j.toTextArea()), u.html(w.val() || f.emptyPara),
                                u.height(x.height ? w.height() : "auto"), g
                                .activate(q), u.focus()), g.updateCodeview(
                                o.toolbar(), F)
                        }
                        v(e)
                    }
                ...
                E = function (b) {
                    ...
                    g.css({
                        width: j.c + "em",
                        height: j.r + "em"
                    }), f.attr("data-value", j.c + "x" + j.r), 3 < j.c && j
                        .c < 10 && h.css({
                            width: j.c + 1 + "em"
                        }), 3 < j.r && j.r < 10 && h.css({
                            height: j.r + 1 + "em"
                ...
                F = function (b) {
                    ...
                    a(document).on("dragenter", function (a) {
                        ...
                        f || 0 !== c.length || (b.editor.addClass(
                                "dragover"), d.width(b.editor.width()),
                            d.height(b.editor.height()), e.text(
                                "Drag Image Here")), c = c.add(a.target)
                    }).on("dragleave", function (a) {
                        c = c.not(a.target), 0 === c.length && b.editor
            ...
            this.bindKeyMap = function (a, b) {
                ...
                e.on("keydown", function (a) {
                    var f = [];
                    a.metaKey && f.push("CMD"), a.ctrlKey && f.push(
                        "CTRL"), a.shiftKey && f.push("SHIFT");
                    var g = i.nameFromCode[a.keyCode];
                    g && f.push(g);
                    var h = b[f.join("+")];
                    h ? (a.preventDefault(), d[h](e, c.data("options"))) :
                        i.isEdit(a.keyCode) && d.recordUndo(e)
                })
            }, this.attach = function (a, b) {
                this.bindKeyMap(a, b.keyMap[c.bMac ? "mac" : "pc"]), a.editable
                    .on("mousedown", u), a.editable.on("keyup mouseup", v),
                    a.editable.on("scroll", w), a.editable.on("paste", x),
                    b.disableDragAndDrop || F(a), a.handle.on("mousedown",
                        y), a.toolbar.on("click", A), a.popover.on("click",
                        A), a.toolbar.on("mousedown", z), a.popover.on(
                        "mousedown", z), a.statusbar.on("mousedown", C);
                var e = a.toolbar,
                    f = e.find(".note-dimension-picker-mousecatcher");
                if (f.on("mousemove", E), a.editable.on("blur", function () {
                        d.saveRange(a.editable)
                    }), a.editor.data("options", b), b.styleWithSpan && !c.bMSIE &&
                    setTimeout(function () {
                        document.execCommand("styleWithCSS", 0, !0)
                    }), a.editable.data("NoteHistory", new n), b.onenter &&
                    a.editable.keypress(function (a) {
                        a.keyCode === i.ENTER && b.onenter(a)
                    }), b.onfocus && a.editable.focus(b.onfocus), b.onblur &&
                    a.editable.blur(b.onblur), b.onkeyup && a.editable.keyup(
                        b.onkeyup), b.onkeydown && a.editable.keydown(b.onkeydown),
                    b.onpaste && a.editable.on("paste", b.onpaste), b.onToolbarClick &&
                    a.toolbar.click(b.onToolbarClick), b.onChange) {
                    var g = function () {
                        b.onChange(a.editable, a.editable.html())
                    };
                    c.bMSIE ? a.editable.on(
                        "DOMCharacterDataModified, DOMSubtreeModified, DOMNodeInserted",
                        g) : a.editable.on("input", g)
                }
                ...
                a.editable.off(), a.dropzone.off(), a.toolbar.off(), a.statusbar
                    .off(), a.popover.off(), a.handle.off(), a.dialog.off()
            }
        },
        t = function () {
            var b = function (a, b) {
                    ...
                    return
                        ...
                        (f ? " " + f : "") + (g ? " dropdown-toggle" : "") +
                        '"' + (g ? ' data-toggle="dropdown"' : "") + (e ?
                            ' title="' + e + '"' : "") + (c ?
                            ' data-event="' + c + '"' : "") + (d ?
                            " data-value='" + d + "'" : "") +
                        ' tabindex="-1">' + a + (g ?
                ...
                e = function (a, b) {
                    return '<div class="' + a +
                        ' popover bottom in" style="display: none;"><div class="arrow"></div><div class="popover-content">' +
                        b + "</div></div>"
                },
                g = function (a, b, c, d) {
                    return '<div class="' + a +
                        ...
                        (b ?
                            '<div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">&times;</button><h4>' +
                            b + "</h4></div>" : "") +
                        '<div class="modal-body"><div class="row-fluid">' +
                        c + "</div></div>" + (d ?
                            '<div class="modal-footer">' + d + "</div>" :
                            "") + "</div></div></div>"
                },
                h = {
                    picture: function (a) {
                        return d("fa fa-picture-o icon-picture", {
                            event: "showImageDialog",
                            title: a.image.image
                        })
                    },
                    link: function (a) {
                        return d("fa fa-link icon-link", {
                            event: "showLinkDialog",
                            title: a.link.link
                        })
                    },
                    video: function (a) {
                        return d("fa fa-youtube-play icon-play", {
                    ...
                    table: function (a) {
                        ...
                        return d("fa fa-table icon-table", {
                            title: a.table.table,
                            dropdown: b
                        })
                    },
                    style: function (a, b) {
                        var c = b.styleTags.reduce(function (b, c) {
                            var d = a.style["p" === c ? "normal" :
                                c];
                            return b +
                                '<li><a data-event="formatBlock" data-value="' +
                                c + '">' + ("p" === c || "pre" ===
                                    c ? d : "<" + c + ">" + d +
                                    "</" + c + ">") + "</a></li>"
                        }, "");
                        return d("fa fa-magic icon-magic", {
                            title: a.style.style,
                    ...
                    fontname: function (a, c) {
                        var d = c.fontNames.reduce(function (a, b) {
                                return a +
                                    '<li><a data-event="fontName" data-value="' +
                                    b +
                                    '"><i class="fa fa-check icon-ok"></i> ' +
                                    b + "</a></li>"
                            }, ""),
                            e = '<span class="note-current-fontname">' + c.defaultFontName +
                            "</span>";
                        return b(e, {
                            title: a.font.name,
                            dropdown: '<ul class="dropdown-menu">' +
                    ...
                    fontsize: function (a, c) {
                        var d = c.fontSizes.reduce(function (a, b) {
                                return a +
                                    '<li><a data-event="fontSize" data-value="' +
                                    b +
                                    '"><i class="fa fa-check icon-ok"></i> ' +
                                    b + "</a></li>"
                            }, ""),
                            e =
                            '<span class="note-current-fontsize">11</span>';
                        return b(e, {
                            title: a.font.size,
                            dropdown: '<ul class="dropdown-menu">' +
                                d + "</ul>"
                    ...
                    color: function (a) {
                        var c =
                            ...
                            a.color.background +
                            '</div><div class="note-color-reset" data-event="backColor" data-value="inherit" title="' +
                            a.color.transparent + '">' + a.color.setTransparent +
                            '</div><div class="note-color-palette" data-target-event="backColor"></div></div><div class="btn-group"><div class="note-palette-title">' +
                            a.color.foreground +
                            '</div><div class="note-color-reset" data-event="foreColor" data-value="inherit" title="' +
                            a.color.reset + '">' + a.color.resetToDefault +
                            '</div><div class="note-color-palette" data-target-event="foreColor"></div></div></li></ul>',
                            f = b("", {
                                title: a.color.more,
                                dropdown: e
                            });
                    ...
                    bold: function (a) {
                        return d("fa fa-bold icon-bold", {
                            event: "bold",
                            title: a.font.bold
                        })
                    },
                    italic: function (a) {
                        return d("fa fa-italic icon-italic", {
                            event: "italic",
                            title: a.font.italic
                        })
                    },
                    underline: function (a) {
                        return d("fa fa-underline icon-underline", {
                            event: "underline",
                            title: a.font.underline
                        })
                    },
                    strike: function (a) {
                        return d("fa fa-strikethrough icon-strikethrough", {
                            event: "strikethrough",
                            title: a.font.strike
                        })
                    },
                    clear: function (a) {
                        return d("fa fa-eraser icon-eraser", {
                            event: "removeFormat",
                            title: a.font.clear
                        })
                    },
                    ul: function (a) {
                        return d("fa fa-list-ul icon-list-ul", {
                            event: "insertUnorderedList",
                            title: a.lists.unordered
                        })
                    },
                    ol: function (a) {
                        return d("fa fa-list-ol icon-list-ol", {
                            event: "insertOrderedList",
                            title: a.lists.ordered
                        })
                    },
                    paragraph: function (a) {
                        var b = d("fa fa-align-left icon-align-left", {
                                title: a.paragraph.left,
                                event: "justifyLeft"
                            }),
                            c = d("fa fa-align-center icon-align-center", {
                                title: a.paragraph.center,
                                event: "justifyCenter"
                            }),
                            e = d("fa fa-align-right icon-align-right", {
                                title: a.paragraph.right,
                                event: "justifyRight"
                            }),
                            f = d("fa fa-align-justify icon-align-justify", {
                                title: a.paragraph.justify,
                                event: "justifyFull"
                            }),
                            g = d("fa fa-outdent icon-indent-left", {
                                title: a.paragraph.outdent,
                                event: "outdent"
                            }),
                            h = d("fa fa-indent icon-indent-right", {
                                title: a.paragraph.indent,
                                event: "indent"
                            }),
                            i =
                            '<div class="dropdown-menu"><div class="note-align btn-group">' +
                            b + c + e + f +
                            '</div><div class="note-list btn-group">' + h +
                            g + "</div></div>";
                        return d("fa fa-align-left icon-align-left", {
                    ...
                    height: function (a, b) {
                        var c = b.lineHeights.reduce(function (a, b) {
                            return a +
                                '<li><a data-event="lineHeight" data-value="' +
                                b +
                                '"><i class="fa fa-check icon-ok"></i> ' +
                                b + "</a></li>"
                        }, "");
                        return d("fa fa-text-height icon-text-height", {
                            title: a.font.height,
                            dropdown: '<ul class="dropdown-menu">' +
                                c + "</ul>"
                        })
                    ...
                    help: function (a) {
                        return d("fa fa-question icon-question", {
                            event: "showHelpDialog",
                            title: a.options.help
                        })
                    },
                    fullscreen: function (a) {
                        return d("fa fa-arrows-alt icon-fullscreen", {
                            event: "fullscreen",
                            title: a.options.fullscreen
                        })
                    },
                    codeview: function (a) {
                        return d("fa fa-code icon-code", {
                            event: "codeview",
                            title: a.options.codeview
                        })
                    },
                    undo: function (a) {
                        return d("fa fa-undo icon-undo", {
                            event: "undo",
                            title: a.history.undo
                        })
                    },
                    redo: function (a) {
                        return d("fa fa-repeat icon-repeat", {
                            event: "redo",
                ...
                i = function (a) {
                    var c = function () {
                            var b = d("fa fa-edit icon-edit", {
                                    title: a.link.edit,
                                    event: "showLinkDialog"
                                }),
                                c = d("fa fa-unlink icon-unlink", {
                                    title: a.link.unlink,
                                    event: "unlink"
                                }),
                                f =
                        ...
                        f = function () {
                            var c = b(
                                ...
                                h = d("fa fa-align-left icon-align-left", {
                                    title: a.image.floatLeft,
                                    event: "floatMe",
                                    value: "left"
                                }),
                                i = d("fa fa-align-left icon-align-right", {
                                    title: a.image.floatRight,
                                    event: "floatMe",
                                    value: "right"
                                }),
                                j = d(
                                    "fa fa-align-justify icon-align-justify", {
                                        title: a.image.floatNone,
                                        event: "floatMe",
                                        value: "none"
                                    }),
                                k = d("fa fa-trash-o icon-trash", {
                                    title: a.image.remove,
                                    event: "removeMedia",
                                    value: "none"
                                }),
                                l = '<div class="btn-group">' + c + f + g +
                                '</div><div class="btn-group">' + h + i + j +
                                '</div><div class="btn-group">' + k +
                                "</div>";
                            return e("note-image-popover", l)
                        };
                    return '<div class="note-popover">' + c() + f() +
                        "</div>"
                },
                j = function () {
                    return
                ...
                k = function (a, b) {
                    return
                        '<table class="note-shortcut"><thead><tr><th></th><th>' +
                        a + "</th></tr></thead><tbody>" + b +
                        "</tbody></table>"
                },
                l = function (a) {
                    var b = "<tr><td>âŒ˜ + B</td><td>" + a.font.bold +
                        "</td></tr><tr><td>âŒ˜ + I</td><td>" + a.font.italic +
                        "</td></tr><tr><td>âŒ˜ + U</td><td>" + a.font.underline +
                        "</td></tr><tr><td>âŒ˜ + â‡§ + S</td><td>" + a.font
                        .strike + "</td></tr><tr><td>âŒ˜ + \\</td><td>" + a
                        .font.clear + "</td></tr>";
                    return k(a.shortcut.textFormatting, b)
                },
                m = function (a) {
                    var b = "<tr><td>âŒ˜ + Z</td><td>" + a.history.undo +
                        "</td></tr><tr><td>âŒ˜ + â‡§ + Z</td><td>" + a.history
                        .redo + "</td></tr><tr><td>âŒ˜ + ]</td><td>" + a.paragraph
                        .indent + "</td></tr><tr><td>âŒ˜ + [</td><td>" + a.paragraph
                        .outdent + "</td></tr><tr><td>âŒ˜ + ENTER</td><td>" +
                        a.hr.insert + "</td></tr>";
                    return k(a.shortcut.action, b)
                },
                n = function (a) {
                    var b = "<tr><td>âŒ˜ + â‡§ + L</td><td>" + a.paragraph.left +
                        "</td></tr><tr><td>âŒ˜ + â‡§ + E</td><td>" + a.paragraph
                        .center +
                        "</td></tr><tr><td>âŒ˜ + â‡§ + R</td><td>" + a.paragraph
                        .right + "</td></tr><tr><td>âŒ˜ + â‡§ + J</td><td>" +
                        a.paragraph.justify +
                        "</td></tr><tr><td>âŒ˜ + â‡§ + NUM7</td><td>" + a.lists
                        .ordered +
                        "</td></tr><tr><td>âŒ˜ + â‡§ + NUM8</td><td>" + a.lists
                        .unordered + "</td></tr>";
                    return k(a.shortcut.paragraphFormatting, b)
                },
                o = function (a) {
                    var b = "<tr><td>âŒ˜ + NUM0</td><td>" + a.style.normal +
                        "</td></tr><tr><td>âŒ˜ + NUM1</td><td>" + a.style.h1 +
                        "</td></tr><tr><td>âŒ˜ + NUM2</td><td>" + a.style.h2 +
                        "</td></tr><tr><td>âŒ˜ + NUM3</td><td>" + a.style.h3 +
                        "</td></tr><tr><td>âŒ˜ + NUM4</td><td>" + a.style.h4 +
                        "</td></tr><tr><td>âŒ˜ + NUM5</td><td>" + a.style.h5 +
                        "</td></tr><tr><td>âŒ˜ + NUM6</td><td>" + a.style.h6 +
                        "</td></tr>";
                ...
                p = function (a, b) {
                    var c = b.extraKeys,
                        d = "";
                    for (var e in c) c.hasOwnProperty(e) && (d +=
                        "<tr><td>" + e + "</td><td>" + c[e] +
                        "</td></tr>");
                ...
                q = function (a, b) {
                    var c =
                        '<table class="note-shortcut-layout"><tbody><tr><td>' +
                        m(a, b) + "</td><td>" + l(a, b) +
                        "</td></tr><tr><td>" + o(a, b) + "</td><td>" + n(a,
                            b) + "</td></tr>";
                    return b.extraKeys && (c += '<tr><td colspan="2">' + p(
                        a, b) + "</td></tr>"), c += "</tbody</table>"
                },
                r = function (a) {
                    return a.replace(/âŒ˜/g, "Ctrl").replace(/â‡§/g,
                        "Shift")
                },
                s = function (a, b) {
                    var d = function () {
                            var b = "<h5>" + a.image.selectFromFiles +
                                '</h5><input class="note-image-input" type="file" name="files" accept="image/*" /><h5>' +
                                a.image.url +
                                '</h5><input class="note-image-url form-control span12" type="text" />',
                                c =
                                '<button href="#" class="btn btn-primary note-image-btn disabled" disabled>' +
                                a.image.insert + "</button>";
                            return g("note-image-dialog", a.image.insert, b,
                                c)
                        },
                        e = function () {
                            var c = '<div class="form-group"><label>' + a.link
                                .textToDisplay +
                                '</label><input class="note-link-text form-control span12" type="text" disabled /></div><div class="form-group"><label>' +
                                a.link.url +
                                '</label><input class="note-link-url form-control span12" type="text" /></div>' +
                                (b.disableLinkTarget ? "" :
                            ...
                            return g("note-link-dialog", a.link.insert, c,
                                d)
                        },
                        f = function () {
                            var b = '<div class="form-group"><label>' + a.video
                                .url +
                                '</label>&nbsp;<small class="text-muted">' +
                                a.video.providers +
                                '</small><input class="note-video-url form-control span12" type="text" /></div>',
                                c =
                                '<button href="#" class="btn btn-primary note-video-btn disabled" disabled>' +
                                a.video.insert + "</button>";
                            return g("note-video-dialog", a.video.insert, b,
                                c)
                        },
                        h = function () {
                            var d =
                                ...
                                a.shortcut.close +
                                '</a><div class="title">' + a.shortcut.shortcuts +
                                "</div>" + (c.bMac ? q(a, b) : r(q(a, b))) +
                                '<p class="text-center"><a href="//hackerwins.github.io/summernote/" target="_blank">Summernote 0.5.2</a> Â· <a href="//github.com/HackerWins/summernote" target="_blank">Project</a> Â· <a href="//github.com/HackerWins/summernote/issues" target="_blank">Issues</a></p>';
                            return g("note-help-dialog", "", d, "")
                        };
                    return '<div class="note-dialog">' + d() + e() + f() +
                        h() + "</div>"
                },
                t = function () {
                    return
                ...
                v = function (a) {
                    return c.bMac && (a = a.replace("CMD", "âŒ˜").replace(
                        "SHIFT", "â‡§")), a.replace("BACKSLASH", "\\").replace(
                        "SLASH", "/").replace("LEFTBRACKET", "[").replace(
                        "RIGHTBRACKET", "]")
                },
                w = function (b, c, d) {
                    var e = u(c),
                ...
                x = function (b, c) {
                    ...
                    b.find(".note-color-palette").each(function () {
                        for (var b = a(this), c = b.attr(
                                "data-target-event"), e = [], f = 0,
                            g = d.length; g > f; f++) {
                            for (var h = d[f], i = [], j = 0, k = h.length; k >
                                j; j++) {
                                var l = h[j];
                                i.push([
            ...
            this.createLayout = function (b, d) {
                var e = b.next();
                if (!e || !e.hasClass("note-editor")) {
                    var g = a('<div class="note-editor"></div>');
                    d.width && g.width(d.width), d.height > 0 && a(
                        '<div class="note-statusbar">' + t() + "</div>").prependTo(
                        g);
                    var k = !b.is(":disabled"),
                        l = a(
                            '<div class="note-editable" contentEditable="' +
                            k + '"></div>').prependTo(g);
                    d.height && l.height(d.height), d.direction && l.attr(
                        "dir", d.direction), l.html(f.html(b) || f.emptyPara),
                        a('<textarea class="note-codable"></textarea>').prependTo(
                            g);
                    for (var m = a.summernote.lang[d.lang], n = "", o = 0,
                        p = d.toolbar.length; p > o; o++) {
                        var q = d.toolbar[o];
                        n += '<div class="note-' + q[0] + ' btn-group">';
                        for (var r = 0, u = q[1].length; u > r; r++) n += h[
                            q[1][r]](m, d);
                        n += "</div>"
                    }
                    n = '<div class="note-toolbar btn-toolbar">' + n +
                        "</div>";
                    var v = a(n).prependTo(g),
                        y = d.keyMap[c.bMac ? "mac" : "pc"];
                    x(v, d), w(v, y, "bottom");
                    var z = a(i(m)).prependTo(g);
                    w(z, y), a(j()).prependTo(g);
                    var A = a(s(m, d)).prependTo(g);
                    ...
                    ).prependTo(g), g.insertAfter(b), b.hide()
                }
    ...
    a.fn.extend({
        summernote: function (b) {
            if (b = a.extend({}, a.summernote.options, b), this.each(
                function (c, d) {
                    var e = a(d);
                    u.createLayout(e, b);
                    var g = u.layoutInfoFromHolder(e);
                    v.attach(g, b), f.isTextarea(e[0]) && e.closest(
        ...
        code: function (b) {
            if (void 0 === b) {
                ...
                if (e && e.editable) {
                    ...
                    return f && c.bCodeMirror && e.codable.data(
                            "cmEditor").save(), f ? e.codable.val() : e
                        .editable.html()
                }
                return d.html()
            }
        ...
        destroy: function () {
            return this.each(function (b, c) {
                ...
                e && e.editable && (v.dettach(e), u.removeLayout(
                    d))
            }), this
        }
    })
