    ...
    init: function(sockjs) {
        ...
        mgr.on("store-contact", _.bind(function(socket, args) {
            ...
            if(event && user) {
                ...
                logger.debug("PREF Contact : " + JSON.stringify(args.preferredContact, 4, null));
                //Regular expression test for email input
                
                if(args.preferredContact.emailInfo === "" && args.preferredContact.twitterHandle === ""
                && args.preferredContact.linkedinURL === "" && args.noShareVal === false) {
                    return;
                }
                ...
                if(args.preferredContact.emailInfo) {
                    var isEmailValid = args.preferredContact.emailInfo.match(emailRegX);
                ...
                if(args.preferredContact.twitterHandle) {

                    var isTwitterValid = args.preferredContact.twitterHandle.match(twitterRegex);
                ...
                if(args.preferredContact.linkedinURL) {

                    var isLinkedinValid = args.preferredContact.linkedinURL.match(linkedinRegex);
                ...
                user.set("noShare", args.noShareVal);
                user.save();
