    ...
    init: function(sockjs) {
        ...
        mgr.on("join", _.bind(function(socket, args) {
            ...
            if (channel == "event") {
                ...
                // entire list of connected participants, because some session
                // users might not have loaded the app (e.g. if they joined the
                // hangout via an out-of-band link).  Those participants are 
                // managed in `session/set-connected-participants`.
