...
module.exports = {
    ...
    route: function(app, db, options) {
        ...
        app.post("/followup/event/:id/sent/", utils.ensureAuthenticated, utils.ensureSuperuser, function(req, res) {
            ...
            async.each(userData, function(userSet, callback) {

                var participantIndex = userData.indexOf(userSet);
                ...
                res.render("email_template.ejs", {
                    ...
                    message = {
                        ...
                        "to": [{
                                "email": userSet.user.get("emails")[0].value,
                                "name": userSet.user.getShortDisplayName() 
                            }],
                        "headers": {
