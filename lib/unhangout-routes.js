...
module.exports = {
    ...
    route: function(app, db, options) {
        ...
        app.get("/followup/event/:id/participant_:participantIndex", function(req, res) {

            var event = db.events.get(req.params.id);

            var eventTitle = event.get("title");
            var history = event.get("history");
            var participantIndex = req.params.participantIndex; 
        ...
        app.post("/followup/event/:id/sent/", function(req, res) {
            ...
            for (var participantIndex = 0; participantIndex < allUserIdsCount; participantIndex++) {
                    ...
                    message = {
                        ...
                        "to": [{
                                "email": allUserIds[participantIndex].user.get("emails")[0].value,
                                "name": allUserIds[participantIndex].user.getShortDisplayName() 
                            }],
                        "headers": {
