...
module.exports = {
    ...
    route: function(app, db, options) {
        ...
        app.get("/followup/event/:id/participant_:participantIndex", utils.ensureAuthenticated, utils.ensureSuperuser, function(req, res) {
            ...
            var participantIndex = parseInt(req.params.participantIndex);

            if(userData && participantIndex !== null && !isNaN(participantIndex)) {
                res.render("post_event_followup_email_preview.ejs", {
                    participantIndex: participantIndex,
                    recipient: userData[participantIndex],
                    userData: userData,
        ...
        app.post("/followup/event/:id/sent/", utils.ensureAuthenticated, utils.ensureSuperuser, function(req, res) {
            ...
            async.each(userData, function(userSet, callback) {
                ...
                res.render("post_event_followup_email.ejs", {
                    event: event,
                    recipient: userData[participantIndex],
                    userData: userData,
                    participantIndex: participantIndex
                    ...
                    message = {
                        ...
                        "headers": {
                            "Reply-To": "noreply@media.mit.edu"
                        },
                    ...
                    mandrill_client.messages.send({"message": message}, function(result) {
                        ...
                        if(emailsSent == userData.length) {
                            logger.info("All emails have been sent succcessfully");
                ...
                if(err) {
                    ...
                    logger.error("An email could not be sent");
                    res.send(500, "An error occured");
