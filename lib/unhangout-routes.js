...
module.exports = {
    ...
    route: function(app, db, options) {
        ...
        app.post("/admin/event/new", ensureAuthenticated, ensureAdmin, _.bind(function(req, res) {
            ...
            var tzInput = moment.tz(dateAndTime, timeZoneValue).format();

            var tzFormat = moment.tz(tzInput, 
                timeZoneValue).format("dddd, MMMM Do YYYY, hh:mm Z")
        ...
        app.post("/admin/event/:id", ensureAuthenticated, ensureEventAdmin, _.bind(function(req, res) {
            ...
            var tzFormat = moment.tz(dateAndTime, timeZoneValue).format();
            ...
            event.set("timeZoneFormat", tzFormat);
            event.save();
            ...
            event.logAnalytics({
                ...
                timeZoneFormat: event.get("timeZoneFormat"),
            });
