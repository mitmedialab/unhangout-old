...
module.exports = function(db, options) {
    ...
    group.assignGroupToUser = function(userId, eventId) { 
        ...
        /* for testing purpose uncomment the following set preference 
        as null and return */
        ...
        if(!pref || pref[eventId] == '' || pref[eventId] == undefined) {
            ...
            if(event.get("sessions").length == 0) {
                ...
                /* if there are sessions then iterate over the list and 
                check for the ones which were created in the randomized
                event mode */
