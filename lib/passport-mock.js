...
var mockUsers = {
    ...
    'noemails': {
        id: "5",
        name: {givenName: "UserWith", familyName: "NoEmails"},
        displayName: "UserWithNoEmails",
        "sock-key": "noemails",
        superuser: false
    },
    'nothings': {
...
// Additional mock users for load testing
for (var i = 0; i < 100; i++) {
    mockUsers["loader" + i] = {
        id: "" + (100 + i),
        name: {givenName: "Loader" + i, familyName: "Mock"},
        displayName: "Loader" + i + " Mock",
        emails: [{value: "loader" + i + "@example.com"}],
        "sock-key": "loader" + i,
        superuser: false
    }
}
