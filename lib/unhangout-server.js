...
exports.UnhangoutServer.prototype = {
	...
	start: function() {
		...
		this.express.get("/h/:code", _.bind(function(req, res) {
			...
			res.render('permalink.ejs', {user:undefined, users:this.users, session:session, event:undefined, _:_, loadApp:false});
		...
		this.express.post("/h/:code", _.bind(function(req, res) {
