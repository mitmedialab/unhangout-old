...
exports.ServerSession = client_models.Session.extend({
    ...
    JOINING_EXPIRATION_TIMEOUT: 30 * 1000,
    ...
    // Send the joiningParticipants data to the event, to be rebroadcast.
    ...
    isDeleted: function() {
        ...
        return !this.get("isPermalinkSession") && !this.get("isHoA") && !this.collection;
    },
