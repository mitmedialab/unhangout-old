...
exports.ServerUser = client_models.User.extend({
    ...
    changeNetworkList: function(roomId, atNameUser, toggle) {
        ...
        prevNetworkList = _.clone(this.get("networkList"));
        ...
        if(prevNetworkList[roomId]) {
            ...
            var index = prevOtherUsers.indexOf(atNameUser.id); 
            ...
            if (index > -1) {
                ...
                if(toggle) {
                    ...
                    this.save({networkList: prevNetworkList});
        ...
        prevOtherUsers.push(atNameUser.id);
