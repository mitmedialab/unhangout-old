...
exports.ServerSession = client_models.Session.extend({
	...
	removeAttendee: function(user) {
		...
		// removing some of this firstAttendee logic, because we don't use it in the UI anymore.
		// leave it here for later; need to do a full cleanse of the first attendee feature later,
		// but this particular part was causing trouble at the moment.		
